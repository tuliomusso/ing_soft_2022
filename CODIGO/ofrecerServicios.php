...
<?php include 'NAV-FOOTER/navbar.php';?>
    ...
    <div class="container">
        <div class="d-grid gap-2">
            <type="button" href="ofrecerServicios.html" class="btn btn-success btn-lg btn-block">¿QUÉ TIPO DE SERVICIO DESEA OFRECER?</type= button>
        </div>
    </div>
    <br>
    <div class="container">
        <div class="container">
                ...
                <div class="col-4">
                    <div class="card" style="width: 17rem;">
                        ...
                        <div class="card-body">
                          ...
                          <a href="#" class="btn btn-success">OFRECER</a>
                        </div>
                      </div>
                </div>
                <div class="col-4">
            ...
            <div class="row mt-5">
                <div class="col-4">
                    <div class="card" style="width: 17rem;">
                        <img class="card-img-top" src="https://i.ibb.co/cCdWX4S/Servicios-generica.jpg">
                        <div class="card-body">
